...
public class DadosSincronizados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dados_sincronizados);
        ...
        lstProblemas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try{
                    tabela = problemaCRUD.listarSQLite(getBaseContext(), 1);
                    ...
                    if((i>=0)&&(i<Lista.lstCodigosProblemas.size())){
                        ...
                        if(problemaGlobal.getUsuario().equals(UsuarioLogin.getUsuario().getNome())){
                            ...
                            Toast.makeText(getBaseContext(), "Apenas o usuario " + problemaGlobal.getUsuario() + " pode remover o problema.",Toast.LENGTH_LONG).show();
                        }
                    }
                }catch(Exception ex){
    ...
    public void remover(View v){
        ...
        try{
            problemaCRUD.removerSQLite(getBaseContext(), problemaGlobal);

            limpar();
            listar();

            Toast.makeText(getBaseContext(),"Problema: "+problemaGlobal.getDescr()+" removido com sucesso!",Toast.LENGTH_SHORT).show();
        }catch(Exception ex){
            Toast.makeText(getBaseContext(),"Erro: "+ex.getMessage(),Toast.LENGTH_SHORT).show();
        }
    }
